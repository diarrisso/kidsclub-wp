...
<footer class="site-footer">
	<div class="container">
		<div class="footer-top">
			<div class="footer-about">
				...
				<div class="footer-social">
					<?php foreach ( $social as $s ) :
						...
						<a href="<?php echo esc_url( $s['url'] ); ?>" target="_blank" rel="noopener" aria-label="<?php echo esc_attr( ucfirst( $s['network'] ) ); ?>"><?php echo $ic; ?></a>
					<?php endforeach; ?>
				</div>
				<?php endif; ?>
			</div>
			...
			<?php foreach ( $cols as $col ) : ?>
				<div class="footer-col">
					...
					<?php if ( ! empty( $col['links'] ) ) foreach ( $col['links'] as $l ) : ?>
		...
		<div class="footer-bottom">
			<span>&copy; <?php echo esc_html( date( 'Y' ) . ' ' . $copy ); ?></span>
